...
\subsection{Log decompression::REQ1}
...
\begin{itemize}
  ...
  \item The programm will delete the decompressed logs on demand by the parser(REQ2).
\end{itemize}

\subsection{Parser::REQ2}
...
\subsection{Connect to Relational Database::REQ6}
\subsubsection{Description and Priority}
\textbf{Priority level=high}\\
\begin{itemize}
...
The databases will receive the following type of queries:
\begin{itemize}
  \item 
\end{itemize}
\subsubsection{Dependencies}
