...
L'interface utilisateur du programme sera composée d'un exécutable (minière de domination) qui sera exécutée avec certains paramètres pour réaliser l'action souhaitée. Le schéma ci-dessous représente les différentes interactions disponibles pour l'utilisateur:\\
